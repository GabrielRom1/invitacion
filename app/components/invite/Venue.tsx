export default function Venue() {
  return (
    <section className="py-8 px-4 sm:px-12 md:px-16 lg:px-24 bg-[#c5a46d] text-white select-none">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-stretch justify-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center items-center text-center border-b lg:border-b-0 lg:border-l border-white/20 pb-6 lg:pb-0 lg:pl-12">
            <h3 className="font-sans text-xs md:text-sm uppercase tracking-[0.3em] font-semibold text-white/80 mb-5 lg:mb-8">
              Detalles Importantes
            </h3>
            
            <div className="grid gap-3 md:gap-4 md:grid-cols-3 lg:max-w-[42rem] w-full items-center justify-center mx-auto">
              <article className="flex flex-col items-center justify-center rounded-2xl border border-white/20 bg-white/10 p-4 md:p-5 text-center shadow-sm min-h-0 w-full max-w-[220px] h-full mx-auto">
                <h4 className="font-serif italic text-[1.35rem] md:text-[1.6rem] leading-tight mb-2 min-h-[2.5rem] md:min-h-[3rem]">
                  Lleguen Temprano
                </h4>
                <p className="font-sans text-xs md:text-sm lg:text-base font-light text-white/90 leading-relaxed">
