...
export default function DetailsAndGifts() {
  ...
  return (
    <>
      <section className="w-full bg-[#fbf8f3] text-[#875e33] py-20 px-6 sm:px-12 md:px-16 select-none font-sans">
        <div className="max-w-3xl mx-auto space-y-24">
          ...
          <div className="text-center">
            ...
            <p className="font-light text-sm md:text-base text-[#875e33]/80 mb-10">
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="space-y-4 font-light text-sm md:text-base text-[#875e33]/90 leading-relaxed balance">
              <p>
